        ...
        <div className="footer-container">
            ...
            <Row>
                <Col sm={{ span: 8 }} xs={{ span: 24 }}>
                    <h2> TENTANG KAMI </h2>{" "}
                    <p>
                        Kami melayani segala <br /> permintaan mengenai <br />
                        agraria baik dalam <br /> kebutuhaan pangan <br />
                        maupun peralatan.
                    </p>
                </Col>
                <Col sm={{ span: 8 }} xs={{ span: 24 }}>
                    <h2> HUBUNGI KAMI </h2>
                    <p>
                        Kantor Farmology <br /> Jl.Jalan Veteran No .8,
                        Ketawanggede, <br /> Kecamatan Lowokwaru, Kota Malang,
                        Jawa Timur 65145
                    </p>
                    <p>
                        Senin - Jumat 09.00 - 17.00 <br /> Email: help
                        @farmology.com
                    </p>
                </Col>
                <Col sm={{ span: 8 }} xs={{ span: 24 }}>
